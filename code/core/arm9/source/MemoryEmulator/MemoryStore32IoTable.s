...
.macro memu_ioRegStore32Pointer index
    ...
    .elseif (\index << 2) == 0x6C
        .short memu_store32Undefined
    .elseif (\index << 2) == 0xB0
        .short emu_dmaStore32 // REG_DMA0SAD
    .elseif (\index << 2) == 0xB4
        .short emu_dmaStore32 // REG_DMA0DAD
    .elseif (\index << 2) == 0xB8
        .short emu_dma012CntStore32 // REG_DMA0CNT
    .elseif (\index << 2) == 0xBC
        .short emu_dmaStore32 // REG_DMA1SAD
    .elseif (\index << 2) == 0xC0
        .short emu_dmaStore32 // REG_DMA1DAD
    .elseif (\index << 2) == 0xC4
        .short emu_dma012CntStore32 // REG_DMA1CNT
    .elseif (\index << 2) == 0xC8
        .short emu_dmaStore32 // REG_DMA2SAD
    .elseif (\index << 2) == 0xCC
        .short emu_dmaStore32 // REG_DMA2DAD
    .elseif (\index << 2) == 0xD0
        .short emu_dma012CntStore32 // REG_DMA2CNT
    .elseif (\index << 2) == 0xD4
        .short emu_dmaStore32 // REG_DMA3SAD
    .elseif (\index << 2) == 0xD8
        .short emu_dmaStore32 // REG_DMA3DAD
    .elseif (\index << 2) == 0xDC
